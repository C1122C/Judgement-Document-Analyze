...
from jdac.code.model.ce_order_con3mul import ModelConfig, CNN
...
con_v_save_path = save_dir + '/checkpoints/' + tm_path + '/con_3mul/best_validation'
con_v_tensor_board_dir = save_dir+'/tensor_board/' + tm_path + '/con_3mul/best_validation'
